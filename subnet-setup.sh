...
nohup python3 neurons/miner.py --netuid 32 --wallet.name default --wallet.hotkey jackie_hotkey_22 --logging.debug --neuron.device cuda:0 --axon.port 7101 --axon.external_port  42161 --subtensor.network finney   >> miner_jackie_hotkey_22.log &
